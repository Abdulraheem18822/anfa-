...
export const AdminPortalModal: React.FC<AdminPortalModalProps> = ({
  ...
  const handlePublishCustomDesignAsProduct = (design: CustomDesignUpload) => {
    ...
    setProductForm({
      ...
      description: `Exclusive artist graphic custom printed on premium 240 GSM bio-washed heavy cotton. Submitted by customer (${design.customerEmail || (design as any).customerPhone || 'Store User'}).`,
      fabricGsm: 240,
      fabricComposition: '100% Super-Combed Bio-Washed Organic Cotton',
      fitType: 'oversized',
      printTechnique: 'Direct-to-Garment (DTG) 300 DPI Eco Pigment',
      qualityGrade: 'Export Quality Grade A+',
      printDimension: ((design as any).printDimension as StandardPrintDimension) || '11x16',
      sizes: ['S', 'M', 'L', 'XL', '2XL'],
      availableColors: [
        { name: 'Pitch Black', hex: '#1E1E24' },
        { name: 'Pure White', hex: '#FFFFFF' },
